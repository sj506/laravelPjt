...
Route::prefix('boards')->group(function () {
    ...
    Route::get('del', [BoardController::class, 'del'])->name('boards.del');

    Route::get('upd', [BoardController::class, 'upd'])->name('boards.upd');

    Route::post('updProc', [BoardController::class, 'updProc'])->name('boards.updProc');
});
